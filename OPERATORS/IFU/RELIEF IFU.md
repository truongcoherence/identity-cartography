...
**constraints, visibility, available actions, unavailable actions, determining variables.**
...
The breakthrough — the hinge — is often hidden.
...
Here is the **clean, austere, canon‑tone reordering** of the Relief Distortions.  
I grouped them by **structural category** rather than by surface phrasing — so the order reflects the *geometry* of the mis‑sees, not the sequence in which they were remembered.

You can paste this directly into your vault.
...
Relief operates on **load**, not **mindset**, **identity**, or **well‑being**.  
Interpret Relief as **identity physics**, not counseling, coping strategy, or emotional care.
