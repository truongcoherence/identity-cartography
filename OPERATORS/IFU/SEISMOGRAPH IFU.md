...
### **1. Distinct Structures**

Each structure must be internally coherent and constraint‑driven.
...
Success
A clean internal click: “This was structural.”
...
Valid actions: request replacements reactively, escalate urgency.

Structure B — Supply Chain Procurement Cycle
Optimizes for: predictability and throughput.
Constraints: vendor lead times, budget cycles, approval gates.
Valid actions: require early forecasting, batch requests, deny late submissions.
...
Valid action: request when degradation becomes visible.

Supply Chain Structure
Responds to: fiscal and logistical constraints.
Constraint pattern: proactive, stable, throughput‑dependent.
Valid action: enforce early planning.
...
A valid action in one structure becomes a violation in the other.

Collision 2 — Demand Variability
Clinical demand is volatile.
Supply Chain demand must be stable.

Clinical variability → Supply Chain overload.
Supply Chain stability → Clinical undersupply.

Collision 3 — Success Conditions
Clinical success = replace equipment before it impacts care.
Supply Chain success = replace equipment within planned cycles.
